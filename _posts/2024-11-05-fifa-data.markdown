...
SWITCH(
    ...
    'Table'[Whole team average age] >= 23 && 'Table'[Whole team average age] < 24,"23-24",'Table'[Whole team average age] >= 24 && 'Table'[Whole team average age] < 25, "24-25",'Table'[Whole team average age] >= 25 && 'Table'[Whole team average age] < 26, "25-26","26+"
)
```
